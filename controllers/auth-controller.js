...
module.exports.developerCheck = async (req, res, next) => {


  if (req.cookies.developerToken == undefined) {
    res.redirect("/login");
  } else {
    next();
  }
...
module.exports.customerCheck = async (req, res, next) => {
...
module.exports.projectManagerCheck = async (req, res, next) => {


  if (req.cookies.projectManagerToken == undefined) {
    res.redirect("/login");
  } else {
    next();
  }
