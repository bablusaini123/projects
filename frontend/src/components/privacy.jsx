          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Collectively refers to the EarningPay Website, Application, and/or App available on the Android Play Store or iOS App Store.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  The User unequivocally agrees that this Policy and the Terms and Conditions constitute a legally binding agreement between the User and EarningPay. The User shall be subject to the rules, guidelines, policies, terms, and conditions applicable to any service provided by EarningPay, and the same shall be deemed incorporated into the Terms and Conditions. This document is an electronic record in terms of the Information Technology Act, 2000 and rules thereunder, as applicable, and the amended provisions pertaining to electronic records in various statutes. This electronic record is generated by a computer system and does not require physical or digital signatures. EarningPay retains the right to amend or modify this Policy and Terms without prior notice to the User. Any such changes shall come into effect immediately upon being updated on the Platform. Users are advised to review the Policy periodically. Continued use of the Services constitutes consent to the updated terms.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  EarningPay may collect, store, and process the following information:
                  <ul className="list-disc pl-5 mt-2">
                    ...
                    <li>Device data, browser patterns, and clicks on/from EarningPay;</li>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <ul className="list-disc pl-5 mt-2">
                    ...
                    <li>Send transactional, promotional, or referral-based communications. Users may opt-out by contacting <a href="mailto:earningpay.in1@gmail.com" className="text-blue-600 hover:underline">earningpay.in1@gmail.com</a>;</li>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  EarningPay may share data with trusted third parties (e.g., payment gateways, analytics providers, or partner retailers) in compliance with this Policy.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  User data is stored securely using industry-standard practices, including encryption, firewalls, and access controls. However, EarningPay is not liable for unauthorized access caused by User negligence (e.g., weak passwords). Users must notify us of any suspicious account activity at <a href="mailto:earningpay.in1@gmail.com" className="text-blue-600 hover:underline">earningpay.in1@gmail.com</a>.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <ul className="list-disc pl-5 mt-2">
                    ...
                    <li>Request account deletion or data removal by contacting <a href="mailto:earningpay.in1@gmail.com" className="text-blue-600 hover:underline">earningpay.in1@gmail.com</a>.</li>
                  </ul>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  EarningPay uses cookies to track User interactions and transactions for cashback or affiliate purposes. Users can disable cookies via browser settings but doing so may affect cashback eligibility.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  EarningPay acts as an intermediary between retailers and Users. Cashback or commissions are subject to confirmation by partner retailers and may be cancelled in cases like order returns or policy violations.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  EarningPay Private Limited<br />
                  [Your Company Address]<br />
                  Email: <a href="mailto:earningpay.in1@gmail.com" className="text-blue-600 hover:underline">earningpay.in1@gmail.com</a>
                </p>
              </section>
            </div>
          </div>
